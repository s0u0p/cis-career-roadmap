...
Goal Setting — Students set short-term, mid-term, and long-term career goals which are saved for the session.
Career Research — Students explore career fields, job roles, salary data, and growth projections pulled from the O*NET API.
Skills Development — Displays personalized certification recommendations based on the student's top 3 career matches from the assessment.
Action Plan — Students build a personalized action plan based on their assessment results and goals.
